...
| **Active** | Authority continuity has strict readers, closed IR profiles, private reconciliation, an explicit private safe-continuation verdict, and a [Gate 4 review that defers exposure](docs/authority-continuity-gate-4-review.md) |
| **Ready next** | Commit an accepted continuity clean fixture, then add its versioned result envelope, composition refusals, and CLI failure tests |
