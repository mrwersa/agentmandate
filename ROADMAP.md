...
| **Ready next** | Producer exposure needs an accountable clean fixture, explicit unsupported-composition behavior, and CLI failure tests; its stable finding codes and private result envelope are complete. Continuity needs its separate presentation review |
