...
| **Active** | Authority continuity and finite producer cardinality have strict readers, closed IR profiles, and private consumers; public presentation review remains |
| **Ready next** | Review the public exposure, trust-failure output, and composition boundaries for continuity and finite producer cardinality before selecting any stable API or CLI surface |
