...
| **Ready next** | Finite producer cardinality has reproduced exhaustion evidence, a bounded contract, and a strict private reader/migration; IR projection, analysis, and public review remain |
