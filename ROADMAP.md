...
| **Active** | Authority continuity has strict readers, closed IR profiles, private reconciliation, and a [Gate 4 review that defers exposure](docs/authority-continuity-gate-4-review.md) |
| **Ready next** | Define continuity safe-continuation semantics and a clean fixture, then add its versioned result envelope, composition refusals, and CLI failure tests |
