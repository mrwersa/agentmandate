...
| **Ready next** | Producer exposure needs an accountable clean fixture, stable finding codes and result envelope, explicit unsupported-composition behavior, and CLI failure tests; continuity needs its separate presentation review |
