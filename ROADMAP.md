...
| **Active** | Authority continuity has strict readers, closed IR profiles, private reconciliation, an explicit private safe-continuation verdict, a synthetic accepted clean fixture, a private versioned result envelope, a closed private composition-refusal matrix, and a [Gate 4 review that defers exposure](docs/authority-continuity-gate-4-review.md) |
| **Ready next** | Review the CLI shape, wire composition refusal before file I/O, and prove exit 0/1/2 plus complete-output/no-partial-output behaviour |
