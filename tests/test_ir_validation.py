...
def test_relation_registry_declares_cardinality_merge_and_support_predicate() -> None:
    assert {
        ...
        "after_state": ("one", "single", "after", False, "input"),
        "at_hop": ("one", "single", "hop", False, "input"),
        "before_state": ("one", "single", "before", False, "input"),
        "bounds_output": ("one", "single", "output", False, "input"),
        "bounds_producer": ("one", "single", "producer", False, "input"),
        "binds_boundary": ("one", "single", "boundary", False, "input"),
        "binds_mandate": ("one", "single", "mandate", False, "input"),
        ...
        "enforces_for": ("many", "union", "decisions", False, "input"),
        ...
        "observes_decision": ("many", "union", "decisions", False, "input"),
        "partitioned_by": ("one", "single", "partition", False, "input"),
        "maps_to_tool": ("one", "single", "tool", False, "input"),
        ...
        "state_of": ("one", "single", "boundary", False, "input"),
